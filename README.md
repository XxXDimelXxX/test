...
В этом проекте архитектура выбрана так, чтобы:

Показать правильную финансовую модель

Минимизировать количество скрытых ошибок

Сделать систему легко анализируемой

Заложить фундамент для дальнейшего масштабирования

Полный пересчёт баланса — это осознанный выбор в пользу надёжности и прозрачности, а не упрощение из-за незнания production-подходов.
